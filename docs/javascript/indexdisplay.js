...
var myImage = uploadedImage || "";


var display = "https://rigpadorji.github.io/japaneseresumecreater/resume.html?year=" +  encodeURIComponent(year) +"&month=" + encodeURIComponent(month)+ "&date="+ encodeURIComponent(date)+ "&furigana=" +encodeURIComponent(furigana)+ "&romaji=" +encodeURIComponent(romaji)+"&dobyear="+ encodeURIComponent(dobyear)+"&dobmonth=" + encodeURIComponent(dobmonth)+ "&dobdate=" + encodeURIComponent(dobdate)+"&sex=" + encodeURIComponent(sex)+"&addinfurigana="+ encodeURIComponent(addinfurigana)+"&addinromaji=" +encodeURIComponent(addinromaji)+"&phone=" +encodeURIComponent(phone)+"&email="+encodeURIComponent(email)+"&collegeyear1=" +encodeURIComponent(collegeyear1) + "&collegemonth1=" +encodeURIComponent(collegemonth1)+"&collegeyear2=" +encodeURIComponent(collegeyear2) + "&collegemonth2=" +encodeURIComponent(collegemonth2)+"&collegename=" + encodeURIComponent(collegename)+"&schoolyear1=" +encodeURIComponent(schoolyear1) + "&schoolmonth1=" +encodeURIComponent(schoolmonth1)+"&schoolyear2=" +encodeURIComponent(schoolyear2) + "&schoolmonth2=" +encodeURIComponent(schoolmonth2)+"&schoolname=" + encodeURIComponent(schoolname)+"&skillyear1=" +encodeURIComponent(skillyear1) + "&skillmonth1=" +encodeURIComponent(skillmonth1)+"&skillyear2=" +encodeURIComponent(skillyear2) + "&skillmonth2=" +encodeURIComponent(skillmonth2)+"&skillname=" + encodeURIComponent(skillname)+"&work1year1=" +encodeURIComponent(work1year1) + "&work1month1=" +encodeURIComponent(work1month1)+"&work1year2=" +encodeURIComponent(work1year2) + "&work1month2=" +encodeURIComponent(work1month2)+"&work1name=" + encodeURIComponent(work1name)+"&work2year1=" +encodeURIComponent(work2year1) + "&work2month1=" +encodeURIComponent(work2month1)+"&work2year2=" +encodeURIComponent(work2year2) + "&work2month2=" +encodeURIComponent(work2month2)+"&work2name=" + encodeURIComponent(work2name)+"&work3year1=" +encodeURIComponent(work3year1) + "&work3month1=" +encodeURIComponent(work3month1)+"&work3year2=" +encodeURIComponent(work3year2) + "&work3month2=" +encodeURIComponent(work3month2)+"&work3name=" + encodeURIComponent(work3name)+"&licence1year=" + encodeURIComponent(licence1year)+"&licence1month=" + encodeURIComponent(licence1month)+"&licence1name=" + encodeURIComponent(licence1name)+"&licence2year=" + encodeURIComponent(licence2year)+"&licence2month=" + encodeURIComponent(licence2month)+"&licence2name=" + encodeURIComponent(licence2name)+"&licence3year=" + encodeURIComponent(licence3year)+"&licence3month=" + encodeURIComponent(licence3month)+"&licence3name=" + encodeURIComponent(licence3name)+"&hour=" + encodeURIComponent(hour)+"&minute=" + encodeURIComponent(minute)+"&marriage=" + encodeURIComponent(marriage)+"&childyes=" + encodeURIComponent(childyes)+"&child=" + encodeURIComponent(child)+"&appealpoint=" + encodeURIComponent(appealpoint)+"&myImage=" + encodeURIComponent(myImage);
